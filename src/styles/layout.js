...
export const StyledLanding = styled.main.attrs({
    ...
    & {
      ${tw`px-6 py-4 sm:flex sm:justify-between sm:p-16`}
      div#content{
          p:nth-child(1){
       ...
       p:nth-child(2){
        ...
        button{
            ...
            ${tw`mt-4 ml-48 mt-12 text-white hover:text-black hover:bg-gray-400 font-bold  rounded-full cursor-pointer px-8 py-4 `}
        }
    }
    div#image{
  ...
  export const StyledRegister = styled.main.attrs({
    ...
    & {
      ${tw` px-6 py-4 flex flex-wrap items-center sm:justify-between sm:p-16`}
}
  `;
