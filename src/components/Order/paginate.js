...
export default (props) => {
        return (
       <div className="bg-white w-7/12 overflow-auto px-4 py-3 flex items-center sm:px-6">
 ...
 Previous
  ...
  <div className="hidden sm:flex-1 ml-32 sm:flex sm:items-center sm:justify-between my-16">
    {!props.loading && props.pagination && props.pagination.total > 0 && <div>
      <p className="text-sm px-2 text-red-700 dark:text-gray-700">
        Showing
    ...
    <div className="bg-black">
      {!props.loading && props.pagination && props.pagination.total > 0 && <nav className="relative z-0 inline-flex shadow-sm -space-x-px" aria-label="Pagination">
        ...
        <span  className="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium bg-white dark:text-gray-700 text-red-700 hover:bg-gray-50">
