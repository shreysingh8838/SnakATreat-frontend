    ...
    <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
      <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
        <table className="min-w-full divide-y divide-gray-200">
          <thead>
            <tr>
              <th scope="col" className="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-red-500 dark:text-gray-500 dark:text-gray-500 uppercase tracking-wider">
                Item
              </th>
              <th scope="col" className="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-red-500 dark:text-gray-500 uppercase tracking-wider">
                Price(₹)
              </th>
              <th scope="col" className="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-red-500 dark:text-gray-500 uppercase tracking-wider">
                Qty
          ...
          {props.items && props.items.map((order,i) => (
            ...
            <td className="px-6 py-4 whitespace-nowrap">
              ...
              <img className="h-10 w-10 rounded-full object-cover" src={order.image && order.image !== DEFAULT_IMAGE_FROM_SERVER ? order.image :Item1} alt="item"/>
                ...
                <div className="ml-4">
                  <div className="text-sm font-medium uppercase text-red-500 dark:text-gray-500">
            ...
            <td className="px-6 py-4 whitespace-nowrap">
              <div className="text-sm text-red-500 dark:text-gray-500">{order.price && order.price}</div>
            </td>
            <td className="px-6 py-4 whitespace-nowrap">
              <span className="px-2  text-xs leading-5 font-semibold rounded-full ">
             <div className="text-sm text-red-500 dark:text-gray-500">
            ...
            <td className="px-6 py-4 whitespace-nowrap text-sm text-red-500 dark:text-gray-500">
