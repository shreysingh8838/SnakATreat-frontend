        ...
        <>
          <div className="side-menu">
            ...
            <div className="side-menu mt-12">
                ...
                <div className="flex flex-col">
                    <label className="inline-flex items-center mt-3">
                     <input onChange={(e) => props.change(e,"reviews") } type="checkbox" className="cursor-pointer h-8 w-8 form-tick dark:text-black text-red-900 appearance-none border dark:border-black border-blue-900 rounded-md checked:bg-gray-600 checked:border-transparent text-center focus:outline-none p-1" defaultValue="1-10" /><span className="ml-2 dark:text-gray-700 text-red-700">1 - 10</span>
                    </label>
                    <label className="inline-flex items-center mt-3">
                    ...
                    <label className="inline-flex items-center mt-3">
                     <input onChange={(e) => props.change(e,"reviews") } type="checkbox" className="cursor-pointer h-8 w-8 form-tick dark:text-black text-red-900 appearance-none border dark:border-black border-blue-900 rounded-md checked:bg-gray-600 checked:border-transparent text-center focus:outline-none p-1" defaultValue="50-*"/><span className="ml-2 dark:text-gray-700 text-red-700">50+</span>
                    </label>
                </div>
            </div>
            <div className="side-menu mt-12">
                ...
                <div className="flex flex-col">
                <p className="py-2 dark:text-gray-700 text-red-700 font-bold"> Rating meter: {props.rating}</p>
                    <label className="inline-flex items-center mt-3">
                    <input type="range" onChange= {(e) => props.change(e,"rating")} className="appearance-none h-1 outline-none w-full dark:bg-black bg-red-700 rounded" min="0" max="5" name="ratings" defaultValue="0"></input>
                    </label>
                </div>
            </div>
            {props.role === ADMIN ? (
            <div className="side-menu mt-12">
                ...
                <div className="flex flex-col">
                    <label className="inline-flex items-center mt-3">
                     <input onChange= {(e) => props.change(e,"active")} type="checkbox" className="cursor-pointer h-8 w-8 form-tick dark:text-black text-red-900 appearance-none border dark:border-black border-blue-900 rounded-md checked:bg-gray-600 checked:border-transparent text-center focus:outline-none p-1" defaultValue="true"/><span className="ml-2 dark:text-gray-700 text-red-700">Yes</span>
                    </label>
                </div>
            </div>
            ):""}
