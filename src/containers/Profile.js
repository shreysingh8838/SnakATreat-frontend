...
const Profile = (props) => {
  ...
  return (
    <>
<div class="bg-pink-50 dark:bg-white m-4 flex flex-col justify-center items-center shadow overflow-hidden sm:rounded-lg">
  ...
  <div class="w-full border-t border-gray-200">
    <dl>
      <div class="dark:bg-gray-100 bg-indigo-100 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        <dt class="text-sm font-medium text-gray-500">
          Full name
        </dt>
        <dd class="mt-1 text-sm dark:text-gray-900 text-red-900 sm:mt-0 sm:col-span-2">
        {props.name}
        </dd>
      </div>
