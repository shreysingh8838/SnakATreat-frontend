...
const Product = (props) => {
  ...
  return (
      <StyledProduct className="bg-pink-50 dark:bg-white">
      {filter !== 'open'  ? (
          <div className="flex  flex-wrap bg-product-pattern bg-contain md:bg-none justify-center flex-col items-center px-8 md:px-16 ">
                <div className="flex  flex-wrap  bg-product-pattern pb-2 md:px-32 md:py-48 justify-center text-center  text-3xl sm:w-full mt-16 md:mt-8 text-gray-700 md:text-3xl font-bold ">
                  ...
                  Here On <span className="text-gray-900">Snak-A-Treat</span>
                  </p>
                </div>
                <div className="w-full p-4 shadow-xl rounded sm:w-full bg-indigo-900 dark:bg-black ">
                  <form onSubmit={(e)=> { formSubmit(e)}}>
                    <div className="flex flex-wrap justify-center items-center mb-2 ">
                        ...
                        <path d="M55.146,51.887L41.588,37.786c3.486-4.144,5.396-9.358,5.396-14.786c0-12.682-10.318-23-23-23s-23,10.318-23,23  s10.318,23,23,23c4.761,0,9.298-1.436,13.177-4.162l13.661,14.208c0.571,0.593,1.339,0.92,2.162,0.92  c0.779,0,1.518-0.297,2.079-0.837C56.255,54.982,56.293,53.08,55.146,51.887z M23.984,6c9.374,0,17,7.626,17,17s-7.626,17-17,17  s-17-7.626-17-17S14.61,6,23.984,6z"/>
                            ...
                            <input onChange={(e)=>{handleFilterChange(e,"name")}}  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded-full py-4 px-4 pl-10 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-name" type="name" placeholder="Menu name or description"/>
                        </div>
                      <button type="submit" className="w-full md:w-1/4 border border-gray-500 rounded-full bg-red-700 dark:bg-gray-700 hover:bg-white hover:text-black text-white dark:hover:bg-white py-4 px-4 mr-4 leading-tight focus:outline-none focus:bg-white focus:text-black focus:border-gray-500 font-bold"> Search</button>
                        <button className="w-full md:w-1/4 border border-gray-500 rounded-full bg-red-700 dark:bg-gray-700 hover:bg-white hover:text-black text-white dark:hover:bg-white py-4 px-4 leading-tight focus:outline-none focus:bg-white focus:text-black focus:border-gray-500 font-bold"> 
                        <a href="https://food-recommendation-pk.herokuapp.com/" rel="noreferrer"> Get our recommendation</a></button>
                    </div>
                  </form>
                </div>
              ...
              {/* section for the add button admin only */}
              {props.role === ADMIN &&
